...
//                     <div id="maze">
//                         <div id="thingie">
//                             <div className="emo" id="emo">🥺</div>
//                         </div>
//                         <div id="home">
//                             <div className="emo">🏠</div>
//                         </div>
//                         <div className="barrier" id="top"></div>
//                         <div className="barrier" id="bottom"></div>
//                     </div>
//                 </div>
//                 <div className="controls">
//                     <div className="buttons">
//                         <button className="btn" id="bu"><div className="chevron">↑</div></button>
//                         <button className="btn" id="bd"><div className="chevron">↓</div></button>
//                         <button className="btn" id="bl"><div className="chevron">←</div></button>
//                         <button className="btn" id="br"><div className="chevron">→</div></button>
//                     </div>
//                 </div>
//             </div>
//         </div>
